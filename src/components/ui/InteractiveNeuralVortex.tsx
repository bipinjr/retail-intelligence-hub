  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        // SELLEZY Colors: Teal and Deep Blue
        vec3 colorA = vec3(0.02, 0.45, 0.42); // Deep Teal
        vec3 colorB = vec3(0.17, 0.69, 0.65); // Bright Teal
        
        color = mix(colorA, colorB, 0.5 + 0.5 * sin(2.0 * u_scroll_progress + 1.2));
        color += vec3(0.1, 0.0, 0.3) * sin(2.0 * u_scroll_progress + 1.5);
        color = color * noise;
