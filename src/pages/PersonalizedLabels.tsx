                  ...
                  <GlassCard hoverable={false} className="h-full space-y-3">
                    <div className="flex items-start justify-between gap-2">
                      <div>
                        ...
                        <span className="text-[10px] font-mono text-primary-glow border border-primary/40 rounded-full px-2 py-0.5 inline-block mt-1">{p.category}</span>
                      </div>
                    ...
                    <div className="text-xs text-muted-foreground font-mono">{p.price}</div>
                    ...
                    <button onClick={() => setOpenCard(open ? null : p.name)}
